...
class Api {
  ...
  static Future<Response> getObservations({required int patientId , required int medicalRecordId}) async {
    return dio.get('patients/$patientId/medical-records/$medicalRecordId/observations');
  }
  // get ovseravtion by id
  static Future<Response> getObservationById({required int patientId , required int medicalRecordId , required int observationId}) async {
    return dio.get(
        'patients/$patientId/medical-records/$medicalRecordId/observations/$observationId');
  }
   // getObservationImages
  static Future<Response> getObservationImages({required int patientId , required int medicalRecordId , required int observationId}) async {
    return dio.get(
        'patients/$patientId/medical-records/$medicalRecordId/observations/$observationId/images');
  }

  // add image to observation
  static Future<Response> addObservationImage({ required int patientId , required int medicalRecordId , required int observationId , required FormData formData}) async {
    return dio.post('patients/$patientId/medical-records/$medicalRecordId/observations/$observationId/images', data: formData);
  }

  static Future<Response> addObservation({ required int patientId , required int medicalRecordId , required Map<String, dynamic> formData}) async {
    return dio.post('patients/$patientId/medical-records/$medicalRecordId/observations', data: formData);
  }
  ...
  static Future<Response> deleteObservationImage({required int patientId, required int medicalRecordId, required int observationId, int? imageId}) {
    return dio.delete('patients/$patientId/medical-records/$medicalRecordId/observations/$observationId/images/$imageId');
  }

  static Future<Response>  updateObservationName({required int patientId, required int medicalRecordId, required int observationId, required Map formData}) {
    return dio.put('patients/$patientId/medical-records/$medicalRecordId/observations/$observationId', data: formData);
  }

  static Future<Response> getComplementaryExaminations({required int patientId, required int medicalRecordId}) {
    return dio.get('patients/$patientId/medical-records/$medicalRecordId/examinations');
  }

  static Future<Response> addComplementaryExamination({required patientId, required medicalRecordId, required Map formData}) {
    return dio.post('patients/$patientId/medical-records/$medicalRecordId/examinations', data: formData);
  }

  static Future<Response> editComplementaryExamination({required int patientId, required int medicalRecordId, required int examinationId, required Map<String, dynamic> formData}) {
    return dio.put('patients/$patientId/medical-records/$medicalRecordId/examinations/$examinationId', data: formData);
  }

  static Future<Response> deleteComplementaryExamination({required int patientId, required int medicalRecordId, required int examinationId}) {
    return dio.delete('patients/$patientId/medical-records/$medicalRecordId/examinations/$examinationId');
  }

  static Future<Response> getMedicineRequests({required int patientId, required int medicalRecordId}) {
    return dio.get('patients/$patientId/medical-records/$medicalRecordId/medicine-requests');
  }

  static Future<Response> addMedicineRequest({required int patientId, required int medicalRecordId, required Map dataForm}) {
    return dio.post('patients/$patientId/medical-records/$medicalRecordId/medicine-requests', data: dataForm);
  }

  static Future<Response> editMedicineRequest({required int patientId, required int medicalRecordId, required int id, required Map dataForm}) {
    return dio.put('patients/$patientId/medical-records/$medicalRecordId/medicine-requests/$id', data: dataForm);
  }

  static Future<Response> deleteMedicineRequest({required int patientId, required int medicalRecordId, required int id}) {
    return dio.delete('patients/$patientId/medical-records/$medicalRecordId/medicine-requests/$id');
  }

  static Future<Response> getMedicalRecords({required int page, required String search , required bool isActive, required bool isMine}) async {
    return dio.get('medical-records?page=$page${isActive ? '&isActive' : ''}${isMine ? '&mineOnly' : ''}&withPagination=true&q=$search');
  }
